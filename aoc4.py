...
print(f'The amount of full overlaps in group assignments are: \t {overlap}')
...
for pair in pairs:
    ...
    first_contains_second = any(item in first_list for item in second_list) 
    second_contains_first = any(item in second_list for item in first_list) 
    if first_contains_second or second_contains_first:
        overlap += 1

print(f'The amount of overlaps in group assignments are: \t {overlap}')